...
function Blog() {
  return (
    <main>
      ...
      {/* main blog items */}
      <section className="max-w-7xl mx-auto grid lg:grid-cols-3 mt-[120px] gap-9 px-5">
        {/* left blog items */}
          ...
          {[...Array(10)].map((e, i) => (
            ...
            >
              ...
              <div className="flex flex-col gap-7 px-5 ">
                <h1 className="sm:text-[32px] text-xl font-bold">
        ...
        {/* right blog items */}
        <div className="col-span-1 lg:flex flex-col gap-[70px] hidden">
          {/* search-bar  */}
          <SearchBar />
          {/* Recent Posts */}
          <RecentPost />
